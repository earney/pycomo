...
class SRE_Pattern(object):
    ...
    def match(self, string, pos=0, endpos=sys_maxint):
    ...
    def search(self, string, pos=0, endpos=sys_maxint):
    ...
    def findall(self, string, pos=0, endpos=sys_maxint):
...
class _OpcodeDispatcher(_Dispatcher):
    ...
    #function below causes TypeError: scope.context.tree[0].add_generator_declaration is not a function
    '''
